...
<Frame caption="Prompts Page" style={{ maxWidth: 500 }}>
  <img src="/introduction/tutorial/modal-new-prompt.png" />
</Frame>
...
<Frame caption="The Prompt Editor after defining the content and settings">
  <img src="/introduction/tutorial/before-commit.png" />
</Frame>
...
<Frame style={{ maxWidth: 500 }}>
  <img src="/introduction/tutorial/test-variables-modal.png" />
</Frame>
...
<Frame caption="Prompt Test Results" style={{ maxWidth: 500 }}>
  <img src="/introduction/tutorial/prompt-test-results.png" />
</Frame>
...
<Frame caption="Commit Modal" style={{ maxWidth: 500 }}>
  <img src="/introduction/tutorial/commit-modal.png" />
</Frame>
...
<Frame caption="Publish Modal" style={{ maxWidth: 500 }}>
  <img src="/introduction/tutorial/publish-modal.png" />
</Frame>
<br />
<Info>
