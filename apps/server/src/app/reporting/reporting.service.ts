...
export class ReportingService {
  ...
  async saveGaiPlatformReport(
    ...
    const reportToSave: ReportSchema = {
      ...
      duration: dto.responseTimestamp - dto.requestTimestamp,
      ...
      type: "ChatCompletion",
      requestTimestamp: moment(new Date(dto.requestTimestamp)).format("YYYY-MM-DD HH:mm:ss"),
      requestBody: JSON.stringify(requestObject),
      isError: false,
      responseStatusCode: 200,
      responseTimestamp: moment(new Date(dto.responseTimestamp)).format("YYYY-MM-DD HH:mm:ss"),
